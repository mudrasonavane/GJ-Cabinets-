...
function twentythirteen_scripts_styles() {
	...
	wp_enqueue_style( 'twentythirteen-style', get_stylesheet_uri().'/css/bootstrap.min.css', array(),'2013-07-18' );
	wp_enqueue_style( 'twentythirteen-style', get_stylesheet_uri().'/css/font-awesome.min.css', array(), '2013-07-18' );
...
function addMyScript() {
    ...
    wp_enqueue_style('mytheme', get_bloginfo('template_directory').'css/bootstrap.min.css', array('blueprint'), '', 'screen, projection');
}
...
function wptuts_styles_with_the_lot()
{
    ...
    wp_register_style( 'bootstrap-style', get_template_directory_uri() . '/css/bootstrap.min.css', false, '1.0', 'all' );
	
	 // Register the style like this for a theme:

    wp_register_style( 'bootstrap-theme', get_template_directory_uri() . '/css/bootstrap.theme.min.css', false, '1.0', 'all' );
