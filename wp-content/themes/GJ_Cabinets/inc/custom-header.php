<?php
/**
 * Implement a custom header for GJ_Cabinets
 *
 */
...
function twentythirteen_custom_header_setup() {
	$args = array(
		...
		'default-image'          => '%s/images/pattern2.png',
